...
class ListInventoryModel {
  ...
  double getSumprice() {
    ...
    print(sumPrice.toDouble().toStringAsFixed(2));
...
class InventoryModel {
  ...
  InventoryModel({required this.inventoryId, required this.itemModel, required this.price, required this.priceUnit, this.exp, this.mfg});
